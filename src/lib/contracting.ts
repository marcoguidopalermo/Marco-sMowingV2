...
export function computeReportTotals(labour: LabourInput[], receipts: ContractingReceipt[], rates: ContractingRateCard): ContractingReportSnapshot {
  ...
  for (const l of labour) {
    ...
    const rate = rateFor(l.billingRole, rates);
...
// The rental properties list (internal organization only). Corp badge on SJ.
