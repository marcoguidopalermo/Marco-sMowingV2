...
import { DIVISIONS, CREW_NUMBERS, ROUTE_FREQUENCIES, DAYS_OF_WEEK, DEFAULT_EOD_REMINDER, DEFAULT_CREW_SIZE_ALLOWANCE, TRAINING_WINDOW_DAYS, TRAINEE_STALE_HIRE_DAYS, TRAINEE_CREDIT_PCT, DEFAULT_CAPACITY_THRESHOLDS } from '../constants';
import { capacityOrDefault, thresholdsOrDefault, capacityCrewKey } from '../lib/capacity';
import type { CapacityRule } from '../types';
...
// colour thresholds. Values only — this card writes nothing but
// settings.capacity, and the calendar is a read-only reader of it.
function CapacitySettingsCard({ settings, setSettings, isAdmin }: {
