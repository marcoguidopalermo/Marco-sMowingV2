// ProjectMaster — the project/materials quoting workbench (formerly the whole
// of SalesMaster). Now one of the three modules inside the SalesMaster
...
export default function ProjectMaster({ rates, quotes, isAdmin, currentUser, onSaveRates, onSaveQuote, onDeleteQuote }: Props) {
